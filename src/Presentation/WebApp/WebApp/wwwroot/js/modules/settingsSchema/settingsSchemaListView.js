...
import settingsSchemaElementView from './settingsSchemaElementView.js';

class SettingsSchemaListView {
    constructor(id) {
        this.id = id;
        this.pageSize = 50;
        this.pageNumber = 1;
        ...
        this.LABELS = {
            formTitle: "Fmu-Api-Central: Схемы настроек",
            refresh: "Обновить",
            add: "Добавить",
            delete: "Удалить",
            name: "Имя",
        ...
        this.NAMES = {
            ...
            refreshBtn: "settingsSchemaRefreshBtn",
            addBtn: "settingsSchemaAddBtn",
            deleteBtn: "settingsSchemaDeleteBtn",
            dataTable: "settingsSchemaDataTable",
            prevButton: "settingsSchemaPrevButton",
            nextButton: "settingsSchemaNextButton",
            paginationInfo: "settingsSchemaPaginationInfo",
            formId: "settingsSchemaListViewForm"
        };
    }
    ...
    async _loadData() {
        try {
            const data = await settingsSchemaService.list(this.pageNumber, this.pageSize);
    ...
    _showAddDialog() {
        settingsSchemaElementView.showDialog({}, (created) => {
    ...
    _edit(rowId) {
        ...
        settingsSchemaElementView.showDialog(record, (edited) => {
    ...
    async _delete() {
        ...
        webix.confirm({
            ...
            try {
                await settingsSchemaService.delete(recordId);
...
export default async function createSettingsSchemaListView(id) {
    const view = new SettingsSchemaListView(id)
        .delayedDataLoading()
        .render();
