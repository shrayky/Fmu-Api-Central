...
public class CouchDbConfigurationService : ICouchDbConfigurationService
{
    private const string DisabledLogLevel = "none";

    private readonly ILogger<CouchDbConfigurationService> _logger;
    private readonly IHttpClientFactory _httpClientFactory;

    public CouchDbConfigurationService(
    ...
    public async Task<Result> EnsureSettings(DatabaseConnection connection, CancellationToken cancellationToken)
    {
    ...
    private Result<HttpClient> CreateAuthorizedClient(DatabaseConnection connection)
    {
